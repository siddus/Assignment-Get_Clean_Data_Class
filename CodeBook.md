...
The Decription all the varibles for which the data is collected is given below. The same descriptions are used in the submitted final form of summarized data.
